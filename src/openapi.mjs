...
export const openapi = {
  ...
  paths: {
    '/': { get: { operationId: 'serviceHomepage', responses: { '200': { description: 'Human-readable Russian/English homepage and live CSV example.', content: { 'text/html': { schema: { type: 'string' } } } } } } },
